      ...
      <div className='w-[95%] xs:w-[75%]  rounded-3xl bg-home shadow-2xl'>
        ...
        <div className='my-2 px-3 xxs:px-6'>
          <div className='px-2 xxs:px-4 mb-5 border bg-white rounded-xl'>
            ...
            <div className='py-3'>
              <form className='border-t border-b border-yellow-700 *:*:my-4 *:flex *:flex-col sm:*:flex-row *:py-1 sm:*:*:mx-2'>
                <div className=''>
                  <Input label="Auid" value={profileData.auid} />
                  <Input label="Name" value={profileData.fullName} />
                </div>
                <div className=''>
                  <Input label="Father's Name" value={profileData.fatherName} />
                  <Input label="Mother's Name" value={profileData.motherName} />
                </div>
                <div className=''>
                  <Input label="Contact Number" value={profileData.phoneNumber} />
                  <Input label="Email" value={profileData.email} />
                </div>
                <div className=''>
                  <Input label="Address" value={profileData.address} />
                </div>
              </form>
