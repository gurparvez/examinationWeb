...
function Home() {
  return (
    <div className='flex lg:flex-row flex-col py-4 px-9 bg-home justify-evenly'>
      ...
      <div className='lg:w-[50%] p-[15px]'>
        ...
        <div className='ss:m-[15px] xs:m-[10px] my-[5px]'>
          <ul className='flex xs:flex-row flex-col flex-wrap *:flex *:flex-row *:xs:max-w-[50%] *:max-w-full'>
