export const root = `https://examform.onrender.com/api/v1`;
export const api = {
        ...
        contentCard: [
            {
                ...
                content:
                    'Apply Now for Scholarships to Secure Your Spot 100 percent Scholarship for UG Registration -Last date 15 January [...]',
                readMore:
                    'https://auts.ac.in/announcement/100-percent-scholarship-apply-now/',
            },
            {
                ...
                content:
                    '◉ Ph.D Admission Notice 2023 ◉ Syllabus for Ph.D entrance test ◉ Ph.D Entrance Examination 2023-2024 – Important Information ◉ Application Form for entrance test to admission to Ph.D. Programme 2024',
                readMore:
                    'https://auts.ac.in/announcement/ph-d-admission-important-information-and-entrance-exam-application/',
            },
            {
                ...
                content:
                    'This workshop has a two-fold purpose. First to disseminate the key insights of the short-term empirical research project entitled [...]',
                readMore:
                    'https://auts.ac.in/announcement/icssr-sponsored-one-day-workshop-on-27-february-2024/',
            },
        ],
    },
];
